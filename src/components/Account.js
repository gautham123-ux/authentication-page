...
const Account = ( { session } ) => {
    ...
    const getProfile = async () => {
        try {
            ...
            let { data, error, status } = await createClient
            .from('profiles')
    ...
    const updateProfile = async (e) => {
        ...
        try {
            ...
            let { error } = await createClient.from("profiles")
    ...
    return (
      ...
      {loading ? (
        ...
        <form onSubmit={updateProfile} className="form-widget">
          ...
          <div className="text-center">
              <button type="button" className="button" onClick={() => createClient.auth.signOut()}>
                  Sign Out
              </button>
          </div>
        </form>
